...
body:
  ...
  -
    type: note
    intent: warning
    body: 'Sans cettre attribut, le lecteur audio sera&nbsp;invisible.'
  -
    type: text
    title: Loop
    level: h2
  ...
  -
    type: note
    intent: warning
    body: 'Les navigateurs bloquent presque tous cette option à moins qu''ils aillent détectés un engagement de la part de l''utilisateur. Par exemple: avoir déjà déclencher manuellement un son,&nbsp;etc.'
  -
    type: note
    intent: good
